  ...
  const content = computed(() => {
    ...
    return {
      ...
      coaching: {
        ...
        testimonials: (d.coaching_testimonials?.length
          ? d.coaching_testimonials.map((t) => {
              const quote = t.quote?.length ? t.quote.map((b) => b.text).filter(Boolean) : []
              return {
                quote,
                highlight: t.highlight || firstSentence(quote[0]),
                author: t.author || '',
                detail: t.detail || '',
              }
            })
          : [
              {
                ...
                quote: [
                  "J'arrive avec une bonne condition physique, une pratique régulière, des connaissances solides en yoga, biomécanique et hormones. Et une perte de poids verrouillée.",
                  "Un appel avec Lila. Un protocole clair. Des ajustements alimentaires et un programme renfo/cardio taillé à ma ménopause, mon mode de vie, ma personnalité. Pas une méthode standard sortie d'un tiroir : elle a vraiment écouté qui je suis. Ce que j'ai apprécié : la clarté, l'absence totale de blabla, et des solutions vraiment actionnables. Même quand on a des connaissances, on a parfois besoin d'une vraie expertise extérieure pour débloquer ce qui est coincé.",
                  "Lila est aussi quelqu'un de curieux et d'une grande gentillesse. Ça change tout dans le type d'accompagnement qu'elle propose. Je recommande sans hésiter.",
                ],
              },
              {
                author: 'Sabrina',
              ...
              },
              {
                ...
                quote: [
                  "Après 8 ans d'arrêt, Lila a été un véritable cadeau. Cette reprise n'aurait jamais été aussi facile et légère sans elle. Rendez-vous pris, impossible de se débiner : j'étais engagée vis-à-vis d'elle. À chaque séance, un parcours varié et du challenge. On a travaillé plusieurs parties du corps à chaque fois, avec un tapis, un ballon, des lestes et des élastiques. Elle ne m'a jamais lâchée, même fatiguée : tout au plus elle adaptait. J'ai vu ma progression : en un mois, à raison de 2 séances par semaine, j'ai perdu 1,5 kg et je me suis affinée. Mon mental tient bon.",
                  "Même si cet accompagnement d'un mois est terminé, elle est toujours là dans un coin de ma tête : je me sens encore engagée, je l'entends m'encourager, je ne suis pas seule. Et je sais déjà que si un jour je décroche et que j'ai besoin de soutien, ou de changement dans mon programme, c'est elle que j'appellerai. Elle est vraiment dans son élément, solaire, joyeuse. Grâce à elle, j'ai compris l'importance d'avoir un coach sportif pour traverser certains passages. Je vous la conseille à 10000 % !",
                ],
              },
            ]),
      },
